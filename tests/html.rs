...
use comrak::{Arena, parse_document, ComrakOptions, format_html, format_commonmark};
    ...
    F: Fn(&mut ComrakOptions),
{
    ...
    let output = format_html(root, &options);
    ...
    let output_from_rt = format_html(root, &options);
