    ...
    fn postprocess_rtjson_ast(
        ...
        match node.data.borrow_mut().value {
            ...
            NodeValue::Image(ref nl) => {
                // "Image" in rtjson is actualy a media element, with the 'text'
                // being either "img", "vid", or "gif". Any other childeren
                // beneath the image results in something unsupported. Media
                // nodes are generated by the RTE, but can't be generated by
                // hand. Images are normally inline elements, and the RTE
                ...
                // the RTE wrote the images in paragraphs at the document level).
                //
